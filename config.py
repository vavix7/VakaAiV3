...
EMERGENCY_BACKUP_ENABLED = get_bool_env("EMERGENCY_BACKUP_ENABLED", True)
LOCAL_BACKUP_COUNT = get_int_env("LOCAL_BACKUP_COUNT", 4)
BACKUP_DIR = os.getenv("BACKUP_DIR", "backups").strip() or "backups"
LOG_CLEANUP_ENABLED = get_bool_env("LOG_CLEANUP_ENABLED", True)
LOG_RETENTION_DAYS = get_int_env("LOG_RETENTION_DAYS", 90)
TRAINING_ENABLED = get_bool_env("TRAINING_ENABLED", True)
TRAINING_DAY = get_int_env("TRAINING_DAY", 0)
TRAINING_TIME = os.getenv("TRAINING_TIME", "20:00").strip()
TRAINING_TEAM_SIZE = get_int_env("TRAINING_TEAM_SIZE", 4)
AUTO_MUTE_WARNINGS = get_int_env("AUTO_MUTE_WARNINGS", 5)
AUTO_BAN_WARNINGS = get_int_env("AUTO_BAN_WARNINGS", 7)
REPORTS_ENABLED = get_bool_env("REPORTS_ENABLED", True)
SHOP_ENABLED = get_bool_env("SHOP_ENABLED", True)
SHOP_DONATE_APPROVAL = get_bool_env("SHOP_DONATE_APPROVAL", True)
SHOP_BOOST_APPROVAL = get_bool_env("SHOP_BOOST_APPROVAL", True)
DATABASE_CHAT_ID = get_int_env("DATABASE_CHAT_ID", -1004341896089)
